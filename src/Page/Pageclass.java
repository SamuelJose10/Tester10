...
public class Pageclass {
	...
	public void c()
	{
		driver.findElement(frstn).sendKeys("samuel");
		driver.findElement(lstn).sendKeys("jose");
	...
	public void e()
	{
		driver.findElement(emailid).sendKeys("josesamuel382@gmail.com");
		driver.findElement(password).sendKeys("Jose123@sam");
	}
	public void f()
	{
